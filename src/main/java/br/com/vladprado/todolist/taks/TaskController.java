...
import br.com.vladprado.todolist.utils.Utils;
...
public class TaskController {
    ...
    @PostMapping("/")
    public ResponseEntity create(@RequestBody TaksModel taskModel, HttpServletRequest request) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity update(@RequestBody TaksModel taskModel, HttpServletRequest request, @PathVariable UUID id) {
